...
#BSP:modify lcm driver XLBLHLYYL-3 by renzhi.li 20200407 start
BOOT_LOGO = hdplus1640
#BSP:modify lcm driver XLBLHLYYL-3 by renzhi.li 20200407 end
BUILD_AGO_GMS = no
BUILD_KERNEL = yes
BUILD_LK = yes
BUILD_MD32 = no
...
CUSTOM_BUILD_VERNO = CY-X683-H694-E
...
CUSTOM_HAL_IMGSENSOR = ov48b2q_mipi_raw gc803430fps_mipi_raw gc803430fpsext2_mipi_raw ov8856ff_mipi_raw gc02m1b_mipi_raw gc02m1_mipi_raw gc6153_serial_yuv pblcov48b2q_mipi_raw pblcgc803430fps_mipi_raw pblcgc803430fpsext2_mipi_raw pblcov8856ff_mipi_raw pblcgc02m1b_mipi_raw pblcgc02m1_mipi_raw pblcgc6153_serial_yuv
...
#BSP: add XLBSHLJSHH-1 by zhigang.yang for 20200416 start
CUSTOM_HAL_MSENSORLIB = mmc5603_x683
#BSP: add XLBSHLJSHH-1 by zhigang.yang for 20200416 end
...
#BSP: add XLBSHLJSHH-1 by zhigang.yang for 20200416 end
#ITD:modify by camera driver team start
CUSTOM_KERNEL_IMGSENSOR = ov48b2q_mipi_raw gc803430fps_mipi_raw gc803430fpsext2_mipi_raw ov8856ff_mipi_raw gc02m1b_mipi_raw gc02m1_mipi_raw gc6153_serial_yuv
#ITD:modify by camera driver team end
...
#TSD:modify config dir XLBSHLJSHH-2 by sujuan.yao 20200414 start
CUSTOM_MODEM = x683_h694_e1
#TSD:modify config dir XLBSHLJSHH-2 by sujuan.yao 20200414 end
...
#BSP:modify audio bring up XLBEPUB-8 haiping.bai 20200414 start
MTK_AUDIO_NUMBER_OF_MIC = 1
#BSP:modify audio bring up XLBEPUB-8 haiping.bai 20200414 end
...
MTK_BWC_SUPPORT = yes
#TSD:modify modem config XLBSHLJSHH-2 by sujuan.yao 20200414 start
MTK_C2K_LTE_MODE = 0
#TSD:modify modem config XLBSHLJSHH-2 by sujuan.yao 20200414 end
MTK_CAMERA_APP = no
...
#ITD:add cam 3pty function by yu.wang 20200426 start
MTK_CAM_ZSDHDR_SUPPORT = no
#ITD:add cam 3pty function by yu.wang 20200426 end
...
MTK_FM_SUPPORT = yes
#TSD:add fm  antenna TSDT-151 by yunfei.wu 20200415 start
#MTK_FM_SUPPORT_LNA = yes
MTK_FM_GPIO_FUNC = yes
#TSD:add fm  antenna TSDT-151 by yunfei.wu 20200415 end
...
#TSD:modify config dir XLBEBAEE-2 by sujuan.yao 20200414 start
MTK_SIM_HOT_SWAP_COMMON_SLOT = yes
#TSD:modify config dir XLBEBAEE-2 by sujuan.yao 20200414 end
...
#BSP: add XLBSHLJSHH-1 by zhigang.yang for 20200416 end
CUSTOM_TRAN_PROJECT=tran_x683
CUSTOM_TRAN_BOM=tran_x683_e1
MTK_BUILD_VERNO=X683-H694EFGHIJUW-Q-OP-210301V288
TRAN_FINGERPRINT_BUILD_VERNO=210301V288
